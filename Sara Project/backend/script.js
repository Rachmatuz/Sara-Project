...
async function submitCuti() {
    ...
    formData.append('nama', document.getElementById('cutiNama').value);
    formData.append('nip', document.getElementById('cutiNip').value);
    formData.append('jenis', document.getElementById('cutiJenis').value);
    formData.append('tanggal_mulai', document.getElementById('cutiMulai').value);
    formData.append('tanggal_selesai', document.getElementById('cutiSelesai').value);
    formData.append('alasan', document.getElementById('cutiAlasan').value);
    ...
    try {
        ...
        if(result.success) closeModal('modalCuti');
    } catch(e) {
